...
<div className="row m-t-30" dir="rtl">
  <div className="col-md-4 col-s-12">
    <div class="row-10 ratio ratio-1x1 cursor-pointer image" [ngStyle]="{'background-image':' url(' + myImage + ')'}">
      <button class="btn-ovelay" mat-icon-button>
        <mat-icon (click)="openDialog()" [ngStyle]="{'transform': 'scale(4)','color':'white'}">open_with</mat-icon>
      </button>
    </div>
