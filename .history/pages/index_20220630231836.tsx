                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="form-group tnc">
                      ...
                      <label htmlFor="tnc">Dont show this popup again</label>
                    </div>
                  </div>
                </div>{/* /.row */}
              </div>
                ...
                <li>
                  <div className="sg-product">
                    ...
                    <div className="product-info">
                      ...
                      <h3><a href="#">Calvin Klein Mens Slim Fit Suit...</a></h3>  
                      <div className="icons">
                        <ul className="global-list">
                          <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                          <li><a href="#"><span><i className="fas fa-cart-plus" /></span></a></li>
                ...
                <li>
                  <div className="sg-product">
                    ...
                    <div className="product-info">
                      ...
                      <h3><a href="#">Womens Wedding Dress for Bride Lace...</a></h3>  
                      <div className="icons">
                        <ul className="global-list">
                          <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                          <li><a href="#"><span><i className="fas fa-cart-plus" /></span></a></li>
                ...
                <li>
                  <div className="sg-product style-1">
                    ...
                    <div className="product-info">
                      ...
                      <h3><a href="#">Amazon Brand - Goodthreads Womens Dress</a></h3>
                      <div className="icons">
                        <ul className="global-list">
                          <li><a href="#" className="btn btn-primary">Add to cart</a></li>
                          <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                    ...
                    <li>
                      <div className="sg-product">
                        ...
                        <div className="product-info">
                          ...
                          <h3><a href="#">Mens Jogger Pants Drawstring Zipper...</a></h3>
                          <div className="icons">
                            <ul className="global-list">
                              <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                              <li><a href="#"><span><i className="fas fa-cart-plus" /></span></a></li>
                    ...
                    <li>
                      <div className="sg-product">
                        ...
                        <div className="product-info">
                          ...
                          <h3><a href="#">Womens Classic Jersey Stripe Boy Tee</a></h3>
                          <div className="icons">
                            <ul className="global-list">
                              <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                              <li><a href="#"><span><i className="fas fa-cart-plus" /></span></a></li>
                    ...
                    <li>
                      <div className="sg-product">
                        ...
                        <div className="product-info">
                          ...
                          <span className="price"><del>$150.00</del> $85.00</span>
                          <h3><a href="#">Goodthreads Womens Dress...</a></h3> 
                          <div className="icons">
                            <ul className="global-list">
                              <li><a href="#"><span><i className="far fa-heart" /></span></a></li>
                              <li><a href="#"><span><i className="fas fa-cart-plus" /></span></a></li>
