    ...
    <>
      <div className="row m-t-30" dir='rtl'>
        ...
        <div className="col-md-6 col-s-12">
          ...
          <p className="m-2">95% قبالة! مع شهادة ريال 18K الذهب الأبيض لون الفضة 925 حلقة 2 قيراط مختبر خواتم الماس العروس الزفاف الفرقة النساء هدية R128
</p>
            <p className="body-1 m-2" >
