...
import {GQLgetProdects,GQLSetProdect,GQLDeleteProdect,GQLFindByIdProdect,GQLUpdateProdect} from './prodect.gql'
...
export const updateProdect=async(id:String,req:IProdectInput)=>{
        const { data:{updateProdect},errors } = await Client.mutate({
            mutation:GQLUpdateProdect,
            variables:{
                        "updateProdectId": id,
                        "req": req
                      }
