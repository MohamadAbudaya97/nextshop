  ...
  return (
    ...
    <div className="row  white" dir="rtl">
      <div className="col">
        ...
        <span className='m-3 hover'><PhoneInTalkOutlinedIcon style={{color:'#007bff',fontSize:18}}/> المحادثه المباشره </span>
      </div>
      <div className="col">
        <span className='m-3'>
                <Button
                ...
                onClick={handleClick}
              >
               <ArrowDropDownRoundedIcon/><span style={{color:'white'}}>USD</span> 
              </Button>
              <Menu
                id="fade-menu"
                MenuListProps={{
