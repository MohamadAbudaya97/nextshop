...
const Index: NextPage = () => {
  ...
  return (
    ...
    <div className="row  white w-100 " dir="rtl">
      ...
      <div className="col-9 col-md-6 d-flex justify-content-center align-items-center" >
        <TextField className={Style.SearchInput} dir="rtl" id="outlined-basic" label="البحث" variant="outlined" />
      </div>
      <div className="col-md-2 col-0 d-md-flex  align-items-center  d-none">
        <Tooltip title="عربة التسوق" className='m-2'>
        ...
        <Tooltip title="قائمة الرغبات" className='m-2'>
        <IconButton aria-label="cart">
        ...
        <Tooltip title="قارن" className='m-2'>
        <IconButton aria-label="cart">
