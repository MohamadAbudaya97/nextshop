...
const Index: NextPage = () => {
  ...
  return (
  <div className="sticky-top w-100 white mainMenuG" style={{position:"sticky",top:-2}} >
      <div className="row  white w-100 " dir="rtl">
        ...
        <div className="col-9 col-md-5 d-flex  justify-content-center align-items-center mt-1" >
