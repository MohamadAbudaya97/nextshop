  ...
  return (
    ...
    <div className="row  white" dir="rtl">
      <div className="col d-flex justify-content-center align-items-center">
        <span className=''><PermIdentityOutlinedIcon style={{color:'#007bff',fontSize:18}}/>
         <span className='hover '>التسجيل</span>/
         <span className='hover '>تسجيل الدخول</span>
         </span>
        <span className=''><PhoneInTalkOutlinedIcon style={{color:'#007bff',fontSize:18}}/> <span className='hover m-1'>المحادثه المباشره</span> </span>
      </div>
