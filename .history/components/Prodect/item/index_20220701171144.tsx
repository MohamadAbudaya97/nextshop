          ...
          <Paper className="m-3" elevation={3}>
            <div className={Style.mainImage}>
                ...
                <div className={Style.mainOption}>
                    <IconButton  size="small" style={{background:"white"}}>
                      <FavoriteBorderIcon style={{color:"black"}} fontSize="inherit"/>
                    </IconButton>
                    <IconButton  size="small" style={{background:"white",marginTop:5}}>
                      <AddShoppingCartIcon style={{color:"black"}} fontSize="inherit"/>
                    </IconButton>
                    <IconButton  size="small" style={{background:"white",marginTop:5}}>
                      <CompareArrowsIcon style={{color:"black"}} fontSize="inherit" />
                    </IconButton>
                    <IconButton  size="small" style={{background:"white",marginTop:5}}>
                      <VisibilityOutlinedIcon style={{color:"black"}} fontSize="inherit" />
                    </IconButton>
                </div>
