...
const Index: NextPage = () => {
  ...
  return (
    ...
    >
      <SwiperSlide className={Style.itemContent}>
        <div className="container">
          <div className={Style.    margin-left: 350px;}>
            <div className="row">
              <div className="col-md-4">sad</div>
              <div className="col-md-8 align-self-center">asd</div>
            </div>
          </div>
        </div>
      </SwiperSlide>
