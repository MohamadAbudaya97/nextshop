        ...
        <div className={Style.SwiperSlide}>
          <div className='row container w-75'  >
              <div className='row col-md-4 d-flex align-self-md-center justify-content-md-center' dir="ltr">
                <Image  className='row col-md-4 d-flex align-self-md-center justify-content-md-center' src="https://chtstudio.com/demo/ecomart/images/bg/s5.png" alt="sadasd" width={219} height={219}/>
              </div>
