               ...
               <div className="m-3">
              ...
              
                {
                  Props.data.selected.map((item,index)=>
                    <div className="m-3" key={item.title+index.toString()}>
                      <strong>{item.title} :</strong>
                        <div className="d-flex">
                          {
                            item.items.map((data,indexdata)=><Button color="error" className="m-1" key={data.name+indexdata.toString()} variant="outlined">{data.name}</Button>)
                          }
