...
export default function EnhancedTable() {
  ...
  const [selected, setSelected] = React.useState<INumSelected|null>(null);
  ...
  const handleClick = (event: React.MouseEvent<unknown>, Dataselected: INumSelected) => {
    if(selected!=Dataselected){
