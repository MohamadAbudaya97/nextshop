       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider />
                    <Typography className="mt-5" align='center' variant='body2'>صافي الربح $1</Typography>
                    ...
                    <Typography className="mt-1" align='center' variant='h6'>تفاصيل المنتج</Typography>
                    <Divider />
