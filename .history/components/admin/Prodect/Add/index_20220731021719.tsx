                        ...
                        imageFields.map((item,index)=>
                          <>
                            <div className='row' key={index+"imageFields"}>
                              <IconButton  className="col-1 p-0 mt-1 mb-1" size="medium" color="error" aria-label="RemoveIcon" onClick={()=>{
                                imageRemove(index);
                              }}>
                                  <RemoveIcon />
                              </IconButton>
                              <TextField {...register(`image.${index}`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-1 mb-1" id="details" label="يرجى منك وضع رابط الصوره" variant="outlined" />{
                              ...
                              <Typography className="mt-1 mb-1 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
                            </div>
                          </>
                        )
                      }
