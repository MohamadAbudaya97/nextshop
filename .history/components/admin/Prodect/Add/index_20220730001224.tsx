         ...
         <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Typography className="mt-5" align='center' variant='h6'>مميزات
                      <IconButton  color="success" aria-label="RemoveIcon" onClick={()=>{
                       ...
                       specificationFields.map((item,index)=>
                          <>
                            <div className='row' key={index+"specificationFields"}>
                              ...
                              <TextField {...register(`specification.${index}.prodectInformation`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="prodectInformation" label="prodectInformation" variant="outlined" />{
                              ...
                              <TextField {...register(`specification.${index}.details`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="details" label="details" variant="outlined"  />{
