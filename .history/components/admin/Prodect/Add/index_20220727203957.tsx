  ...
  <>
    ...
    >
      <div>
       {previewOpen &&
       <div className="white">
        <IconButton size="large" color="error" aria-label="CancelOutlinedIcon" onClick={()=>setPreview(false)}>
       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <TextField {...register("brand")}  className="col-5 p-0 mt-3" id="brand" label="sadasd" variant="outlined" />
