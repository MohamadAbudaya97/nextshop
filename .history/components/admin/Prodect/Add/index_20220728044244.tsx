  ...
  <>
    ...
    >
      <div>
       ...
       {!previewOpen && <form className={Style.Main} dir='ltr'>
            <div className="white">
                <h3>Set Prodect</h3>
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Typography align='center' variant='h4'>Set Price</Typography>
                    <Divider />
                    ...
                    <Typography align='center' variant='h4'>Set details</Typography>
                    <Divider />
