...
const Home: NextPage = () => {
 ...
 const [minimize,setMinimize] = useState([false,false])
              ...
              <div className="white">
                  ...
                  <div className="row d-flex justify-content-around"> 
                     ...
                     <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                        setMinimize([!minimize[0],...minimize]);
                     }}>
                       {minimize?<KeyboardArrowUpIcon />:<KeyboardArrowDownIcon/>} 
                      </IconButton>
                      <Divider />
                      </div>
                    ...
                    <div className="mb-3" style={{position:"relative"}}>
                        <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                            setMinimize([!minimize[1],...minimize]);
                        }}>
                          {minimize?<KeyboardArrowUpIcon />:<KeyboardArrowDownIcon/>} 
                          </IconButton>
                          <Divider />
                    </div>
                    <div style={{height:minimize[0]?0:"auto",overflow:"hidden"}}></div>
                      {
