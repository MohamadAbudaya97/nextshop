       ...
       type="button"
                            ...
                            </button>
        {
            fields.map((item, index) => {
                return (
                    <>
                        <div className="col-2 p-0 mt-3 mb-3 d-flex">
                            ...
                            <Typography className="mt-3 mb-3 col-2" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
