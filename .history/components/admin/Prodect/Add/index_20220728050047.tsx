       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider />
                    <TextField {...register(`details`)}  className="col-12 p-0 mt-3 mb-3" id="details" label="العنوان" variant="outlined" />
                    <TextField {...register(`details`)}  className="col-12 p-0 mt-3 mb-3" id="details" label="الوصف" variant="outlined" />
