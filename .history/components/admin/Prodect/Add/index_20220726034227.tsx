    ...
    >
        <div className={Style.Main} dir='rtl'>
            ...
            <div className="row"> 
                ...
                <TextField className="col-6 p-0 mt-3" id="specification" label="specification" variant="outlined" />
                <TextField className="col-6 p-0 mt-3" id="comments" label="comments" variant="outlined" />
                <TextField className="col-6 p-0 mt-3" id="relatedProductsIds" label="relatedProductsIds" variant="outlined" />
            </div>
        <Button color="success" className='mt-3' variant="contained">Add</Button>
        <Button color="info" className='mt-3' variant="contained">Preview</Button>
        </div>
    </Module>
  )
}
