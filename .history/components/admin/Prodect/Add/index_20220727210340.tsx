       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider />
                    <TextField {...register("price")}  className="col-4 p-0 mt-3 mb-3" id="price" label="discount" variant="outlined" />  
                    <TextField {...register("price")}  className="col-4 p-0 mt-3 mb-3" id="price" label="cost" variant="outlined" />
                    <TextField {...register("price")}  className="col-4 p-0 mt-3 mb-3" id="price" label="Real Price" variant="outlined" />
                    <Divider />
