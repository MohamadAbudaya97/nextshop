                    ...
                    imageFields.map((item,index)=>
                      <>
                        <div className='row' key={index+"imageFields"}>
                          ...
                          <TextField {...register(`image.${index}`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى منك وضع رابط الصوره" variant="outlined" />{
                    ...
                    <Divider/>
                    {
                      ...
                      <>
                       ...
                       <div className="col-1 p-0 mt-3 mb-3 d-flex">
                          ...
                          <TextField {...register(`selected.${index}.title`,{required: "هذا الحقل مطلوب."})}  className="col-4 p-0 mt-3 mb-3" id="other" label="الصوره" variant="outlined" />{
                            //helperText={errors.other[index]?.title?.message}  error={errors.other[index]?.title?.message?true:false} color={errors.other[index]?.title?.message?"error":"success"}
                          }
                          <TextField {...register(`selected.${index}.title`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="other" label="الاسم" variant="outlined" />{
                            //helperText={errors.other[index]?.title?.message}  error={errors.other[index]?.title?.message?true:false} color={errors.other[index]?.title?.message?"error":"success"}
                          }
                          <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
                        </div>
