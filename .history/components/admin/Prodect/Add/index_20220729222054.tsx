                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider/>
                    {
                      ...
                      <>
                        ...
                        <TextField {...register(`other`)}  className="col-5 p-0 mt-3 mb-3" id="other" label="العنوان" variant="outlined" />
                        <TextField {...register(`other`)}  className="col-5 p-0 mt-3 mb-3" id="other" label="الوصف" variant="outlined" />
                        <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index}</Typography>
                      </>
                    )
                    }
