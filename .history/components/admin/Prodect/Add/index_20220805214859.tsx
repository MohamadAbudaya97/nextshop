...
const handleCloseAddDialog=()=>{
 ...
 const [minimize,setMinimize] = useState([false,false,false,false,false])
  ...
  const AddData =async () =>{
   // console.log(await setProdect(watchAllFields)) 
    setOpenAddDialog(false)
  }
          ...
          <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
              <div className="white">
                  ...
                  <div className="row d-flex justify-content-around"> 
                      ...
                      <TextField {...register("inStock",{required: "هذا الحقل مطلوب.",valueAsNumber: true})} required className="col-5 p-0 mt-3 mb-3" id="inStock" label="الكميه بالمتجر" variant="outlined" helperText={errors.inStock?.message}  error={errors.inStock?.message?true:false} color={errors.inStock?.message?"error":"success"}/>
