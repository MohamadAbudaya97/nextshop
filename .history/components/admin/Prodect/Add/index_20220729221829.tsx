                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider/>
                    {
                      ...
                      <>
                        ...
                        <TextField {...register(`other`)}  className="col-5 p-0 mt-3 mb-3" id="details" label="العنوان" variant="outlined" />
                        <TextField {...register(`other`)}  className="col-5 p-0 mt-3 mb-3" id="details" label="الوصف" variant="outlined" />
