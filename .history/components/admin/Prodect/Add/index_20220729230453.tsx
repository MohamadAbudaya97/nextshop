         ...
         <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    <Divider />
                    <TextField {...register("name",{required:true})} required  className="col-5 p-0 mt-3" id="name" label="الاسم" variant="outlined" helperText={errors.name.ref}/>
                    <TextField {...register("description",{required:true})} required className="col-5 p-0 mt-3" id="description" label="الوصف" variant="outlined" helperText=""/>
                    <TextField {...register("brand",{required:true})} required className="col-5 p-0 mt-3" id="brand" label="البراند" variant="outlined" helperText=""/>
                    <TextField {...register("inStock",{required:true})} required className="col-5 p-0 mt-3 mb-3" id="inStock" label="الكميه بالمتجر" variant="outlined" helperText=""/>
                    ...
                    <TextField {...register("price.price",{required:true})} required type="number" className="col-4 p-0 mt-3 mb-3" id="Price" label="سعر البيع" variant="outlined" helperText=""/>
                    <TextField {...register("price.cost",{required:true})} required type="number" className="col-4 p-0 mt-3 mb-3" id="cost" label="سعر بالجمله" variant="outlined" helperText=""/>
                    ...
                    detailsFields.map((item,index)=>
                      <>
                        <div className='row' key={index+"detailsFields"}>
                          ...
                          <TextField {...register(`details.${index}`,{required:true})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى وضع التفاصيل هنا كنقاط" variant="outlined" helperText=""/>
