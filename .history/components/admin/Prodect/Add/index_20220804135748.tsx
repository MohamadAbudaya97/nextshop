              ...
              <div className="white">
                  ...
                  <div className="row d-flex justify-content-around"> 
                     ...
                     <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                      ...
                      <StyledBadge badgeContent={watchAllFields.image.length} color="secondary">
                          ...
                          imageFields.map((item,index)=>
                            <>
                              <div className='row' key={index+"imageFields"}>
                                ...
                                <TextField {...register(`image.${index}`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-2 mb-2" id="details" label="يرجى منك وضع رابط الصوره" variant="outlined" helperText={errors.name?.message}  error={errors.name?.message?true:false} color={errors.name?.message?"error":"success"}/>
                    ...
                    <div className="mb-3" style={{position:"relative"}}>
                        <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                         ...
                         <StyledBadge badgeContent={watchAllFields.other.length} color="secondary">
                    ...
                    <div style={{height:minimize[1]?0:"auto",overflow:"hidden"}}>
                      {
                        ...
                        <>
                          <div className='row' key={index+"otherFields"}>
                            ...
                            <TextField {...register(`other.${index}.title`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-2 mb-2" id="other" label="الاسم" variant="outlined" helperText={errors.other[index]?.title?.message}  error={errors.other[index]?.title?.message?true:false} color={errors.other[index]?.title?.message?"error":"success"}/>{
                      ...
                      <div className="mb-3" style={{position:"relative"}}>
                          <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                            ...
                            <StyledBadge badgeContent={watchAllFields.selected.length} color="secondary">
                    ...
                    <div style={{height:minimize[4]?0:"auto",overflow:"hidden"}}>
                      ...
                      <div className="mb-3" style={{position:"relative"}}>
                          <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                            ...
                            <StyledBadge badgeContent={watchAllFields.details.length} color="secondary">
                    ...
                    <div style={{height:minimize[2]?0:"auto",overflow:"hidden"}}>
                      ...
                      <div className="mb-3" style={{position:"relative"}}>
                          <IconButton style={{position:"absolute",right:-30,top:-20}} onClick={()=>{
                            ...
                            <StyledBadge badgeContent={watchAllFields.specification.length} color="secondary">
