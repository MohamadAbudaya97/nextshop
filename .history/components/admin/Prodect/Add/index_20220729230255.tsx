         ...
         <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    <Divider />
                    <TextField {...register("name",{required:true})} required  className="col-5 p-0 mt-3" id="name" label="الاسم" variant="outlined" helperText="Incorrect entry."/>
                    <TextField {...register("description",{required:true})} required className="col-5 p-0 mt-3" id="description" label="الوصف" variant="outlined" helperText="Incorrect entry."/>
                    <TextField {...register("brand",{required:true})} required className="col-5 p-0 mt-3" id="brand" label="البراند" variant="outlined" helperText="Incorrect entry."/>
                    <TextField {...register("inStock",{required:true})} required className="col-5 p-0 mt-3 mb-3" id="inStock" label="الكميه بالمتجر" variant="outlined" helperText="Incorrect entry."/>
                    ...
                    <TextField {...register("price.price",{required:true})} required type="number" className="col-4 p-0 mt-3 mb-3" id="Price" label="سعر البيع" variant="outlined" helperText="Incorrect entry."/>
                    <TextField {...register("price.cost",{required:true})} required type="number" className="col-4 p-0 mt-3 mb-3" id="cost" label="سعر بالجمله" variant="outlined" helperText="Incorrect entry."/>
                    <TextField {...register("price.discount")} type="number" required className="col-4 p-0 mt-3 mb-3" id="discount" label="( % ) التخفيض " variant="outlined" helperText="Incorrect entry."/>  
                    ...
                    detailsFields.map((item,index)=>
                      <>
                        <div className='row' key={index+"detailsFields"}>
                          ...
                          <TextField {...register(`details.${index}`,{required:true})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى وضع التفاصيل هنا كنقاط" variant="outlined" helperText="Incorrect entry."/>
                    ...
                    <Divider/>
                    {
                      ...
                      <>
                        <div className='row' key={index+"otherFields"}>
                          ...
                          <TextField {...register(`other.${index}.title`)}  className="col-5 p-0 mt-3 mb-3" id="other" label="الاسم" variant="outlined" helperText="Incorrect entry."/>
                          <TextField {...register(`other.${index}.description`)}  className="col-5 p-0 mt-3 mb-3" id="other" label="وصف المنتج" variant="outlined" helperText="Incorrect entry."/>
                          <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
                        </div>
                      </>
                    )
                       ...
                       specificationFields.map((item,index)=>
                          <>
                            <div className='row' key={index+"specificationFields"}>
                              ...
                              <TextField {...register(`specification.${index}.prodectInformation`)}  className="col-5 p-0 mt-3 mb-3" id="prodectInformation" label="prodectInformation" variant="outlined" helperText="Incorrect entry."/>
                              <TextField {...register(`specification.${index}.details`)}  className="col-5 p-0 mt-3 mb-3" id="details" label="details" variant="outlined" helperText="Incorrect entry."/>
                              <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
                            </div>
                          </>
                       )
