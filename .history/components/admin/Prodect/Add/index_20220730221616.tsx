          ...
          <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
              <div className="white">
                  ...
                  <div className="row d-flex justify-content-around"> 
                      ...
                      <Divider />
                          <div className='row' key={0+"imageFields"}>
                            <IconButton  className="col-1 p-0 mt-3 mb-3" size="medium" color="error" aria-label="RemoveIcon" onClick={()=>{
                              imageRemove(0);
                            }}>
                                <RemoveIcon />
                            </IconButton>
                            <TextField {...register(`image.1`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى منك وضع رابط الصوره" variant="outlined" />{
                      ...
                      imageFields.map((item,index)=>
                        <>
                          <div className='row' key={index+1+"imageFields"}>
                            <IconButton  className="col-1 p-0 mt-3 mb-3" size="medium" color="error" aria-label="RemoveIcon" onClick={()=>{
                              imageRemove(index+1);
                            }}>
                                <RemoveIcon />
                            </IconButton>
                            <TextField {...register(`image.${index+1}`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى منك وضع رابط الصوره" variant="outlined" />{
                              //helperText={errors.image[index]?.message}  error={errors.image[index]?.message?true:false} color={errors.image[index]?.message?"error":"success"}
                            }
                            <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+2}</Typography>
                          </div>
                        </>
                      )
                      }
                      ...
                      <Divider/>
                      {
                        ...
                        <>
                          <div className='row' key={index+"otherFields"}>
                            ...
                            <TextField {...register(`other.${index}.title`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="other" label="الاسم" variant="outlined" />{
                            ...
                            <TextField {...register(`other.${index}.description`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="other" label="وصف المنتج" variant="outlined" />{
                        ...
                        <>
                          <div className='row' key={index+"otherFields"}>
                            <div className="col-1 p-0 mt-3 mb-3 d-flex">
                              <IconButton size="medium" color="success" aria-label="RemoveIcon" onClick={()=>{
                                otherRemove(index)
                              }}>
                                  <AddIcon />
                              </IconButton>
                            ...
                            <TextField {...register(`selected.${index}.title`,{required: "هذا الحقل مطلوب."})}  className="col-10 p-0 mt-3 mb-3" id="other" label="الاسم" variant="outlined" />{
                              //helperText={errors.other[index]?.title?.message}  error={errors.other[index]?.title?.message?true:false} color={errors.other[index]?.title?.message?"error":"success"}
                            }
                            <Typography className="mt-3 mb-3 col-1" style={{display:"flex",justifyContent:"center",alignItems:"center"}}  variant='h6'>{index+1}</Typography>
                      ...
                      detailsFields.map((item,index)=>
                        <>
                          <div className='row' key={index+"detailsFields"}>
                            ...
                            <TextField {...register(`details.${index}`,{required: "هذا الحقل مطلوب."})} required  className="col-10 p-0 mt-3 mb-3" id="details" label="يرجى وضع التفاصيل هنا كنقاط" variant="outlined" />{
                        ...
                        specificationFields.map((item,index)=>
                            <>
                              <div className='row' key={index+"specificationFields"}>
                                ...
                                <TextField {...register(`specification.${index}.name`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3"  label="الاسم" variant="outlined" />{
                                ...
                                <TextField {...register(`specification.${index}.details`,{required: "هذا الحقل مطلوب."})}  className="col-5 p-0 mt-3 mb-3" id="details" label="المواصفه" variant="outlined"  />{
