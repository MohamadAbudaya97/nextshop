       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider />
                    <h3>Price</h3>
                    <TextField {...register("price")}  className="col-5 p-0 mt-3" id="price" label="cost" variant="outlined" />
                    <TextField {...register("price")}  className="col-5 p-0 mt-3" id="price" label="real price" variant="outlined" />
                    <TextField {...register("price")}  className="col-5 p-0 mt-3" id="price" label="discount" variant="outlined" />
                    <Divider />
