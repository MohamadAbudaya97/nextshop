         ...
         <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Typography className="mt-5" align='center' variant='h6'>المزيد               <IconButton  className="col-1 p-0 mt-3 mb-3" size="medium" color="error" aria-label="CancelOutlinedIcon" >
                        <CancelOutlinedIcon />
