    ...
    >
      <div>
       ...
       {!previewOpen && <form className={Style.Main} dir='rtl'>
            <div className="white">
                <Typography align='center' variant='h6'>Set Prodect</Typography>
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Typography align='center' variant='h6'>Set Price</Typography>
                    <Divider />
                    ...
                    <Typography align='center' variant='h6'>Set details</Typography>
                    <Divider />
                    <TextField {...register(`details`)}  className="col-5 p-0 mt-3 mb-3" id="details" label="title" variant="outlined" />
                    <TextField {...register("details")}  className="col-5 p-0 mt-3 mb-3" id="details" label="description" variant="outlined" />
                    <TextField {...register("details")}  className="col-5 p-0 mt-3 mb-3" id="details" label="title" variant="outlined" />
                    <TextField {...register("details")}  className="col-5 p-0 mt-3 mb-3" id="details" label="description" variant="outlined" />
                    <Divider />
