         ...
         <Typography className="mb-5" color="success" variant='h4'>أضافة المنتجات</Typography>
            <div className="white">
                ...
                <div className="row d-flex justify-content-around"> 
                    ...
                    <Divider />
                    <Typography className="mt-2" align='center' color={chickPrice()==0?"green":chickPrice()<0?"red":"green"} variant='body2'>{chickPrice()?`صافي الربح ${chickPrice()}$ `:"يرجى تعبئه الفورم لمعرفه صافي الربح "}</Typography>
