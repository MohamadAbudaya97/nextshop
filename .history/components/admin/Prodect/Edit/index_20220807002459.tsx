  ...
  <>
     ...
     <Dialog
      ...
      >
        ...
        <DialogActions>
          <Button variant='contained' color="error" onClick={handleCloseAddDialog}>
            لا
          </Button>
          <Button autoFocus color="success" variant='contained' onClick={Props.data?EditData:AddData} autoFocus>
            نعم
          </Button>
        </DialogActions>
      </Dialog>
