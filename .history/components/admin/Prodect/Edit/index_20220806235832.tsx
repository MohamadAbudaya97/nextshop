...
const Form: NextPage<FromProps> = (Props) => {
  ...
  const { register, control, handleSubmit,reset,watch, formState: { errors } } = useForm<IProdectInput>({
    defaultValues:{
      ...
      price:Props.data?Props.data?.price:{cost:null,discount:null,price:null},
      rating:Props.data?Props.data?.rating:{average:0,five:0,for:0,three:0,tow:0,one:0,zero:0},
...
const handleCloseAddDialog=()=>{
 ...
 const [minimize,setMinimize] = useState([false,false,false,false,false])
  ...
  const Add = handleSubmit(() => {
    console.log(IProdectInput(watchAllFields) )
