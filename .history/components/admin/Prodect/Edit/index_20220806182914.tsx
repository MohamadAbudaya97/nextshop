...
const Home: NextPage<Props> = (Props) => {
  ...
  const { register, control, handleSubmit,reset,watch,setValue, formState: { errors } } = useForm<IProdectInput>({
    defaultValues:{
      brand:"",
      comments:[],
      description:"",
...
useEffect(() => {
getProdectById(Props.id).then((res)=>{
    setValue(res as IProdect)
    setData(res as IProdect)
 })
 .catch((err)=>{
